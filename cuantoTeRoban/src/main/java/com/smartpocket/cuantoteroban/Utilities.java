...
public class Utilities {
	...
	public static String removeAccentsAndMakeLowercase(String str){
		...
		result = result.replaceAll("[בהגאד]", "a");
		result = result.replaceAll("[יכךט]",  "e");
		result = result.replaceAll("[םןמל]",  "i");
		result = result.replaceAll("[ףצפע]",  "o");
		result = result.replaceAll("[תüûש]",  "u");
		result = result.replaceAll("[ס]",     "n");
