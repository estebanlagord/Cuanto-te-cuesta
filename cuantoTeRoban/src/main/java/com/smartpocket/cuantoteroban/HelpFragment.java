...
import com.smartpocket.cuantoteroban.databinding.FragmentHelpBinding;
...
public class HelpFragment extends Fragment {
    ...
    static class MyAdapter extends FragmentPagerAdapter {
        ...
        @Override
        public int getCount() {
            return HelpFragment.TAB_TITLES.length;
        }
...
//				break;
        ...
        public CharSequence getPageTitle(int position) {
            return HelpFragment.TAB_TITLES[position].toUpperCase(Locale.US);
        }
